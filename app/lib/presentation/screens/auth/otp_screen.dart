...
class _OTPScreenState extends ConsumerState<OTPScreen> {
  ...
  void _handleVerify() async {
    ...
    final success = await ref
        ...
        .verifyOtpAndLogin(otp, name: widget.name);
    if (success && mounted) {
  ...
  Widget build(BuildContext context) {
    ref.listen<AuthState>(authProvider, (previous, next) {
      ...
      if (next.autoFilledCode != null &&
          next.autoFilledCode != previous?.autoFilledCode) {
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: const Center(child: BrandLogo(size: 120)),
                  ),
